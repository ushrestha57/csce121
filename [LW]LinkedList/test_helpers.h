...
/*
// Example of cout_redirect usage
std::ostringstream out;
{
    cout_redirect rout(out.rdbuf());
    // this is redirected to the stringstream
    std::cout << "hello1" << std::endl;
}
// this is back to stdout
std::cout << "hello2" << std::endl;
// this is what was captured from stdout ("hello1")
